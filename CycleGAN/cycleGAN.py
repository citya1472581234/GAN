...
parser.add_argument('--train_epoch', type=int, default=50, help='train epochs num')
...
#  improve stable For running torch.cat((self.real_A, self.fake_B), 1),
#  we just compare the current fake_B and current real_A, 
#  however we could use history image pool data to help the discriminator doesn't forget what it has done wrong before.
#  You can refer to SimGAN, and the following image
